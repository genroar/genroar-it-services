...
function Banner() {
  return (
    ...
    <div className="container lg:max-w-[1305px] lg:px-10">
      <div className="-mx-4 flex flex-wrap items-center pt-[190px]">
        <div className="w-full px-4 lg:w-7/12">
          <div
            className="wow fadeInUp lg:mb-0 lg:max-w-[570px]"
            data-wow-delay=".3s"
          >
            <span className="mb-5 block text-lg font-medium leading-tight text-black dark:text-white sm:text-[22px] xl:text-[22px]">
            Empowering your digital presence with the latest technology
            </span>
            ...
            We are committed to providing innovative mobile and web solutions that combine creativity with technical expertise. Our team transforms your ideas into user-friendly digital experiences that differentiate your brand in today's competitive market.
            </p>
