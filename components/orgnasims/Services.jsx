...
function Services() {
  return (
    <section id="features" className="relative z-10 pt-[150px] pb-[65px]">
      <div className="container">
        <div
          className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center"
          data-wow-delay=".2s"
        >
          ...
          Our services are designed to meet your digital needs, offering tailored mobile and web development, UI/UX design, and technology consulting to help your business thrive.
          </p>
        </div>
      </div>
      <div className="container max-w-[1390px]">
        <div className="rounded-2xl px-5 pb-14 pt-14 shadow-card dark:bg-dark dark:shadow-card-dark md:pb-1 lg:pb-5 xl:px-10">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <p className="text-base text-body">
                Creating custom mobile apps that deliver seamless user experiences across devices.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <p className="text-base text-body">
                Creating responsive, high-performance websites tailored to your business goals.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                data-wow-delay=".2s"
              >
                <div className="mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-gray text-primary duration-300dark:bg-[#2A2E44] dark:text-white dark:group-hover:bg-primary">
                  <svg
                    width={44}
                    height={44}
                    viewBox="0 0 44 44"
                ...
                <p className="text-base text-body">
                Developing reliable and scalable software solutions tailored to your business needs.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                ...
                data-wow-delay=".2s"
              >
                <div className="mx-auto mb-8 flex h-[90px] w-[90px] items-center justify-center rounded-3xl bg-gray text-primary duration-300 dark:bg-[#2A2E44] dark:text-white dark:group-hover:bg-primary">
                  <svg
                    width={44}
                    height={44}
                    viewBox="0 0 44 44"
                ...
                <p className="text-base text-body">
                Creating intuitive and visually appealing designs that increase user engagement.
                </p>
              </div>
            </div>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              ...
              >
                ...
                <p className="text-base text-body">
                Strategically promoting your brand to reach and engage your target audience.
                </p>
              </div>
            </div>
          </div>
